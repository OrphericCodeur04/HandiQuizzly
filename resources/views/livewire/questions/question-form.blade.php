                ...
                <div class="p-6 text-gray-900">
                    <form wire:submit.prevent="save">
                        <div>
                            ...
                            <x-textarea wire:model="question.question_text" id="question_text" class="block mt-1 w-full" type="text" name="question_text" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea wire:model="question.code_snippet" id="code_snippet" class="block mt-1 w-full" type="text" name="code_snippet" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea wire:model="question.answer_explanation" id="answer_explanation" class="block mt-1 w-full" type="text" name="answer_explanation" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model="question.more_info_link" id="more_info_link" class="block mt-1 w-full" type="text" name="more_info_link" />
